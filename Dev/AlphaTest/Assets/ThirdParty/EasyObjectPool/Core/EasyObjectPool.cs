...
namespace MarchingBytes
{
    ...
    class Pool
    {
        ...
        {
            Debug.Log($"poolObjectPrefab:{poolObjectPrefab}");
    ...
    public class EasyObjectPool : MonoBehaviour
    {
        ...
        public List<PoolInfo> poolInfo = new List<PoolInfo>();
        ...
        {
            if (this.poolInfo.Find(x => x.poolName == poolName) == null)
            {
                //Debug.Log($"풀생성중 {poolName}");
